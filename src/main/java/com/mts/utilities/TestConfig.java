package com.mts.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "manitechsoln@gmail.com";
	public static String password = "manish35sonika";
	public static String[] to ={"manishthapa09@gmail.com"};
